...
public class Timer : MonoBehaviour
{
	...
	/// <summary>
	/// Returns time left in timer duration
	/// </summary>
	...
	/// <summary>
	/// Adds given delegate as listener for timer finished event
	/// </summary>
	/// <param name="listener"> no arg listener </param>
